...
def gradually_increase_requests(duration=15):
    """Function to gradually increase the number of requests sent in parallel."""
    start_time = time.time()
    max_workers = 1  # Start with 10 workers
    ...
    while (time.time() - start_time) < duration * 60:
        ...
        max_workers += 1  # Gradually increase the number of workers
...
if __name__ == "__main__":
    # send_request()
    gradually_increase_requests(duration=5)  # Run the test for 5 minutes